...
@app.get("/")
def inicio():
    return {"status": "online", "mensaje": "Bienvenido al sistema de agentes Yeison"}
...
# CONCLUSION: Esta librería nos permite estar trabajando y ver en tiempo real los cambios y validar que todo este funcionando como se espera
...
# CONCLUSION: Cuando existe retorna code 200 y cuando no existe un code 404
...
# CONCLUSION: Cuando se crea y se consulta, se persiste el datos
# Al enviar un mensaje y luego consultar se ve el mensaje antes diligenciados
# Recibo 422 Error: Unprocessable Entity 
