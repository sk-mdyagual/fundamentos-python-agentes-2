...
# CONCLUSION:
"""Se puede comunicar con el servidor desde python usando la libreria request, como si fuera un navegador"""
...
# CONCLUSION:
"""Un cliente envía peticiones al servidor, el servidor responde y los datos se guardan. Tanto el código como el navegador hacen lo mismo, solo cambia la forma de interactuar"""
