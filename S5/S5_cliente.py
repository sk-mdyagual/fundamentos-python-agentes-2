...
# CONCLUSION: El protocolo HTTP es el puente universal. No importa si usamos Python (requests) o el navegador (Swagger UI) — ambos son clientes
#  que hablan el mismo idioma HTTP con el servidor. El resultado es el mismo porque llegan al mismo lugar.
...
# CONCLUSION: El cliente HTTP es la forma real de comunicacion entre sistemas. Ya sea que uses Python (requests) o el navegador (Swagger UI), 
# ambos son clientes que hablan el mismo idioma HTTP con el servidor. El resultado es el mismo porque llegan al mismo lugar.    
