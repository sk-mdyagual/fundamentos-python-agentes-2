...
class PseudoAgente:
    ...
    def __init__(self, name: str = "Slave", energy: int = 100):
        self.name = name
        ...
        self.tokens: int = energy

    def consume_energy(self, energy_consumed: int) -> None:
        self.tokens -= energy_consumed
...
class AgenteAdmin(PseudoAgente):
    ...
    """
    def __init__(self, name="Oráculo", energy: int = 100):
