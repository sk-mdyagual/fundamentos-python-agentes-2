...
if __name__ == "__main__":
    ...
    # CONCLUSION: SQLite almacena los datos de manera persistente en un archivo, permitiendo que la información sobreviva entre ejecuciones del script.
    ...
    # [DB] Error: El agente 'Atlas' ya existe en la base de datos.
    # CONCLUSION: SQLite evita duplicados gracias a la clave primaria.
    ...
    # CONCLUSION: Si existe un archivo agentes.db con el agente Atlas registrado, entonces si. Atlas tiene memoria permanente.
    ...
    # Agente creado: {'nombre': 'Atlas', 'rol': 'explorador', 'energia': 100}
    # Script terminado. ¿Donde quedo el agente Atlas? En ningun lado. La RAM se borro.
    # [DB] Mensaje de 'Atlas' a 'Nova' enviado a las 2026-04-07T07:53:49.714848.
    # [DB] Mensaje de 'Nova' a 'Atlas' enviado a las 2026-04-07T07:53:49.794622.
    # [DB] Mensaje de 'Titan' a 'Nova' enviado a las 2026-04-07T07:53:49.904880.
    # CONCLUSION: Los mensajes se almacenan en la base de datos, por lo que persisten incluso si los agentes en memoria desaparecen.
    # ======================================================
    ...
    # CONCLUSION: Hermes recibe los mensajes de Atlas y Nova, demostrando que la bandeja de entrada funciona correctamente.
